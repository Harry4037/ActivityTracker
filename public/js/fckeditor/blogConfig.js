...
FCKConfig.ToolbarSets["Default"] = [
    ['Bold','Italic','Underline','StrikeThrough','Subscript','Superscript','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','OrderedList',
     'UnorderedList','-','Undo','Redo','Link','Unlink','-','Table','Rule','-','Image','Smiley'],
